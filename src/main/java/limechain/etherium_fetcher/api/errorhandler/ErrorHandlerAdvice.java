 ...
 * @ResponseBody
 * 
 * @ControllerAdvice class ErrorHandlerAdvice {
 * 
 * 
 * @ResponseBody
 * 
 ...
 * 
 * @ResponseStatus(value = HttpStatus.REQUESTED_RANGE_NOT_SATISFIABLE) public
 * ErrorMessage resourceNotFoundException(Exception ex, WebRequest request) {
 * return new ErrorMessage(HttpStatus.REQUESTED_RANGE_NOT_SATISFIABLE.value(),
